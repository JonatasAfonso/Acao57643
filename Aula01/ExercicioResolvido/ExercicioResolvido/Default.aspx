<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ExercicioResolvido.Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Resolução - Exercício 01</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <p>
            &nbsp;</p>
        <p>
            <asp:Button ID="btnGravar" runat="server" OnClick="btnGravar_OnClick_Click" Text="Gravar" />
        </p>
    </form>
</body>
</html>
